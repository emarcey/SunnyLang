...
/*
 * validate_declare_function_syntax:
 * 	- checks a line of code (in token form) and determines if the code is a valid function declaration, with the following results:
 * 		- throws an error if invalid
 * 		- returns 0 if valid and function returns void
 * 		- returns 1 if valid and function has arguments
 *
 * params:
 * 	- tokens: array of Token objects representing the for statement
 * 	- num_tokens: number of Token objects in tokens
